...
//            ma5Buffer[i * 4 + 2] = 0;
//            ma5Buffer[i * 4 + 3] = (float) entrySet.getTradeInfoList().get(currentIndex + 1).getVolumeMa5();
//
//            ma10Buffer[i * 4 + 0] = 0;
//            ma10Buffer[i * 4 + 1] = (float) entry.getVolumeMa10();
//            ma10Buffer[i * 4 + 2] = 0;
//            ma10Buffer[i * 4 + 3] = (float) entrySet.getTradeInfoList().get(currentIndex + 1).getVolumeMa10();
